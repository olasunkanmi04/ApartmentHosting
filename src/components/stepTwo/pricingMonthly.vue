    ...
    <form action @submit.prevent="handleSubmit">
      <div class="bdrm__wrap price__wrap">
        <div class="listing__container">
          <h3 class="listing__title mb-2">Price your space</h3>

          <div class="memRequire">
            <!-- <div class="row mx-0 form__row">
              <div class="col-lg-12 px-0">
                <p class="form__label mb-2" v-if="entireSpace">What is the price of the Entire Space</p>
                <p
            ...
            <div v-if="entireSpace">
              <div class="row mx-0 form__demacator mb-4">
                <div class="col-lg-8 col-sm-12 px-0">
                  <div class="form-group mb-2" v-for="(plan, index) in plans" :key="index">
                    <label
                      for
                      class="form__label"
...
export default {
  ...
  methods: {
    ...
    quarterlyCal() {
      this.quarterlyPrice = this.pricing * 3;
    },
    biannuallyCal() {
      this.biannuallyPrice = this.pricing * 6;
    },
    cumulatePrice() {
      this.quarterlyCal();
      this.biannuallyCal();
    ...
    saveAndExit() {
      ...
      saveAndExit(
        ...
        if (data.data.success) {
          if (this.quarterly || this.biannually) {
            this.incrementLevel();
          } else {
            this.$store.state.level = 6;
          }
        }
      });
    },
        ...
        .then(data => {
          ...
          if (data.data.success) {
            ...
            if (returnedData.space_type == SHARED) {
              ...
              if (returnedData.Rooms[0].Apartment.Plans) {
                this.plans = returnedData.Rooms[0].Apartment.Plans;
              }
              ...
              if (returnedData.Apartment.Plans) {
                this.plans = returnedData.Apartment.Plans;
              }
