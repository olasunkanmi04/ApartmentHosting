    ...
    <section>
      <div class="row mx-0 mb-5">
        <div class="col-lg-6 col-md-6 col-sm-6 col-12 p-0">
          <h2 class="dashboard__heading mr-auto">Subscribed Members</h2>
        </div>
      </div>
        ...
        <div class="bookingList__table-wrapper">
          <div class="dashboard__listing-table-wrap table__head">
            <div class="dashboard__listing-table-head">
              <div class="dashboard__listing-table-cell sub__memberName">
                <p class="dashboard__listing-table-text text-center">Memeber's Name</p>
              </div>
              <div class="dashboard__listing-table-cell sub__spaceName">
                <p class="dashboard__listing-table-text text-center">Space Name</p>
              </div>
              <div class="dashboard__listing-table-cell sub__planType">
                <p class="dashboard__listing-table-text text-center">Subscription Type</p>
              </div>
              <div class="dashboard__listing-table-cell sub__amount">
                <p class="dashboard__listing-table-text text-center">Amount</p>
              </div>
              <div class="dashboard__listing-table-cell sub__days">
                <p class="dashboard__listing-table-text text-center">No of Depleted Days</p>
              </div>
              <div class="dashboard__listing-table-cell sub__status">
          ...
          <div class="dashboard__listing-table-wrap">
            <div
              class="dashboard__listing-table-body sub__row"
              v-for="(searchableRow, index) in searchableRows"
              :key="index"
              @click="viewMember(searchableRow.id)"
            >
              <div class="dashboard__listing-table-cell sub__memberName">
                <p class="dashboard__listing-table-text text-center">{{searchableRow.name}}</p>
              </div>
              <div class="dashboard__listing-table-cell sub__spaceName">
                <p
              ...
              <div class="dashboard__listing-table-cell sub__planType">
                <p class="dashboard__listing-table-text text-center">{{searchableRow.planType}}</p>
              </div>
              <div class="dashboard__listing-table-cell sub__amount">
...
export default {
  ...
  methods: {
    ...
    viewMember(memeberId) {
      this.$router.push("/dashboard/memberSubDetails/" + memeberId);
    },
    showProfile(name) {
