    ...
    <section>
      <div class="row mx-0 mb-5">
        <div class="col-lg-6 col-md-6 col-sm-6 col-12 p-0">
          <h2 class="dashboard__heading mr-auto">Member Bookings</h2>
        </div>
      </div>
        ...
        <div class="bookingList__table-wrapper">
          <div class="dashboard__listing-table-wrap table__head">
            <div class="dashboard__listing-table-head">
              <div class="dashboard__listing-table-cell bookingList__memberName">
                <p class="dashboard__listing-table-text">Memeber's Name</p>
              </div>
              <div class="dashboard__listing-table-cell bookingList__spaceName">
                <p class="dashboard__listing-table-text">Space Name</p>
              </div>
              <div class="dashboard__listing-table-cell bookingList__planType">
                <p class="dashboard__listing-table-text">Type of Plan</p>
              </div>
              <div class="dashboard__listing-table-cell bookingList__amount">
                <p class="dashboard__listing-table-text">Amount</p>
              </div>
              <div class="dashboard__listing-table-cell bookingList__status">
                <p class="dashboard__listing-table-text">Status</p>
              </div>
              <div class="dashboard__listing-table-cell bookingList__action">
                <p class="dashboard__listing-table-text">Action</p>
              </div>
              <div class="dashboard__listing-table-cell bookingList__date">
                <p class="dashboard__listing-table-text text-right">Booking Date</p>
              </div>
            </div>
          </div>
          ...
          <div class="dashboard__listing-table-wrap">
            ...
            >
              <div class="dashboard__listing-table-cell bookingList__memberName">
                <p class="dashboard__listing-table-text">{{searchableRow.name}}</p>
              </div>
              <div class="dashboard__listing-table-cell bookingList__spaceName">
                <p class="dashboard__listing-table-text">{{searchableRow.spaceName | capitalize}}</p>
              </div>
              <div class="dashboard__listing-table-cell bookingList__planType">
                <p class="dashboard__listing-table-text">{{searchableRow.planType}}</p>
              </div>
              <div class="dashboard__listing-table-cell bookingList__amount">
                <p class="dashboard__listing-table-text">{{searchableRow.amount}}</p>
              </div>
              <div class="dashboard__listing-table-cell bookingList__status">
                <p class="dashboard__listing-table-text">{{searchableRow.status | capitalize}}</p>
              </div>
              <div class="dashboard__listing-table-cell bookingList__action">
                <button
                  class="bookingList__action-btn"
                  @click="showProfile(searchableRow.name)"
                >View Booking</button>
                <div class="bookingList__modal">
                  <showProfileModal :name="searchableRow.name" :booking="searchableRow"></showProfileModal>
                </div>
              </div>
              <div class="dashboard__listing-table-cell bookingList__date">
                <p class="dashboard__listing-table-text text-right">{{searchableRow.bookingDate}}</p>
              </div>
            </div>
          </div>
        </div>
...
import showProfileModal from "./bookingProfileModal";
    ...
    return {
      ...
      searchableRows: [
        ...
        },
        {
          ...
          bookingDate: "12-Dec-2019",
          propertyType: "Shared",
          duration: "20/01/2020 - 29/01/2020",
          cost: 180000,
          bedroomName: "Bedroom 3"
        }
      ],
      searchQuery: "",
      searchKey: "",
